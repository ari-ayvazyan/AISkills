...
/plugin install ecp-frontend@AISkills
```
  ...
  "mcpServers": {
    "ecp-bridge": {
      ...
      "args": [
        ...
        "ecp-chat-skills,ecp-code-agent-skills,ecp-frontend"
      ]
    }
  }
}
...
| [generate-app-names](plugins/ecp-chat-skills/skills/generate-app-names) | 👤 | Generates strategic product and application names using linguistic engineering. Trigger when invoked with /generate-app-names | - | - |
